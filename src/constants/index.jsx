export const features = [
  {
    ...
    text: "With Zimax, tedious tasks are history. The most scalable Bitcoin infrastructure today. Get access to the most reliable at-scale Lightning Payments Provider.",
    button: {
  ...
  },
  {
    ...
    text: "Your data security is our priority. With robust privacy controls, Zimax helps keeps your information secure and locked up.",
    button: {
...
export const details = [
  ...
  },
  {
    ...
    title: "100% customizability. 0% stress",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "Infraestructure out of the box",
  },
];
...
export const faq = [
  {
    ...
    answer: "Yes! We offer corporate plans tailored to businesses of all sizes. Contact our sales team for a customized solution that fits your needs."
  },
  {
    id: 2,
    question: "What happens when I’m out of storage?",
    answer: "If you run out of storage, you can upgrade your plan to get more space, or you can manage your existing storage by deleting unnecessary files."
  },
  {
    id: 3,
    question: "Can I upgrade my plan?",
    answer: "Yes! You can upgrade your plan at any time. The upgrade will be applied immediately, and you’ll only pay the difference for the remaining billing cycle."
  },
  {
    id: 4,
    question: "Do you offer training for individuals and teams?",
    answer: "Yes, we provide training sessions for both individuals and teams. Our expert-led courses help you maximize the use of our platform. Contact us for more details."
  }
];
...
export const plans = [
  {
    ...
    features: [
      "2 Compute Credits Standard Node",
      "2 Users",
      "1 BTCPay Account",
      "Ticket Support",
    ],
...
export const testimonials = [
  {
    ...
    comment:
      "Zimax's customer support is second to none! They’re like my tech superheroes, always there when I need them.",
  },
  {
    id: "1",
    name: "Mark Erixon",
  ...
  },
  {
    ...
    comment:
      "Switched to Zimax last month, and I'm already seeing results. Best decision for our team!",
  },
  {
    id: "5",
    name: "Jim Bradley",
